...
namespace EmpresaMonitor.Agent
{
    ...
    // Usa SetWindowDisplayAffinity(WDA_EXCLUDEFROMCAPTURE) para não aparecer na captura
    // remota do operador (requer Windows 10 build 19041+; falha é ignorada silenciosamente).
    // ---------------------------------------------------------------------------
